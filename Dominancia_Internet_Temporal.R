...
Dominancia_Temporal_Internet <- read_csv("TD_ACC_BAF_ITE_VA.csv", locale = locale(encoding = "UTF-8"))

# Paso 2: Crear campo único para municipio
Dominancia_Temporal_Internet <- Dominancia_Temporal_Internet %>%
...
SBAF_SERIE <- Dominancia_Temporal_Internet %>%
